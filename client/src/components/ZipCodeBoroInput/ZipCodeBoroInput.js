...
export default function ZipCodeBoroSelect({ updateDayCountData }) {
    ...
    <div>
      <div className='zipCodeBoroInputContainer'>
        ...
        <div className='boroSelectInput'  >
          <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 0.5, marginBottom: 2, width: "300px" }}>
      ...
      }} variant="outlined" onClick={handleFilterSubmit}>Apply Filters
      </MuiButton>
